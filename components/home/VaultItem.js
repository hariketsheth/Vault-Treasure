...
const StyledVaultstatus = styled(Vaultstatus)`
    grid-column: 2 / 3;
    grid-row: 2 / 4;
    margin-left: auto;
...
export default function VaultItem({ id, paymentDue, clientName, total, status }) {
    return (
        <Link href={`/Vault/${id}`} passHref={true} scroll={false}>
